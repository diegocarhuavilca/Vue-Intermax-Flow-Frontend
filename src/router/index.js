...
const routes = [
  ...
  },
  {
    ...
    component:()=>
    import('../views/legal/PortabilidadNumerica.vue'),
    meta:{
  ...
  },
  {
    ...
    component:()=>
    import('../views/legal/IndicadoresCalidad.vue'),
    meta:{
  ...
  },
  {
    ...
    component:()=>
    import('../views/legal/RedCasosEmergencia.vue'),
    meta:{
  ...
  },
  {
    ...
    component:()=>
    import('../views/legal/NeutralidadRed.vue'),
    meta:{
  ...
  },
  {
    ...
    component:()=>
    import('../views/legal/ProteccionDatos.vue'),
    meta:{
  ...
  },
  {
    ...
    component:()=>
    import('../views/legal/TerminosCondiciones.vue'),
    meta:{
